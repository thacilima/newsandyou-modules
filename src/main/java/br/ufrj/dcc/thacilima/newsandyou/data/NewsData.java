...
public class NewsData {
	...
	public void insert(int idSourceNews, String uri, String title, String subtitle, String imageUrl) throws SQLException {
		
		SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String gottenDateString = dateFormat.format(Calendar.getInstance().getTime());
		
		String sqlInsertAtt = "INSERT IGNORE INTO noticia (id_origem_noticia, uri, titulo, subtitulo, imagem_url, data_coletagem) "
								+"VALUES ('"+ idSourceNews +"', '"+ uri +"', '"+ title +"', '"
									+ subtitle +"', '"+ imageUrl +"', '"+ gottenDateString +"')";		
